  ...
  - [Possible new features](#jump1)
  - [Identify new features to be added](#jump2)
  - [Reasons for choosing these features](#jump3)
  - [Unit testing and integration testing](#jump4)
  ...
  ## <span id="jump2">Identify new features to be added</span>
  ...
  - This feature lets visitors see more detailed information and distinguish different pets.

  - Shopkeeper could delete pets on available page to manage inventory. 
  
  ### Reasons for choosing feature 2
  ...
  ### Reasons for choosing feature 3
  ...
  ## <span id="jump4">Unit testing and integration testing</span>
